...
// this function help pop-up information
...
psd3.Pie.prototype.draw = function(svg, totalRadius, dataset, originalDataset, originalDatasetLength, innerRadius, outerRadius, radiusDelta, startAngle, endAngle, parentCentroid) {
    ...
    psd3.Pie.prototype.textColor = function(d){
      return _this.config.textColor(d);
    };
    psd3.Pie.prototype.textBoder = function(d){
      return _this.config.textBoder(d);
    }
    ...
    //console.log(values);
    // this function handle acction double click and return drilldown
    var dblclick = function(d) {
      // console.log("Click Function Handdle")
      //console.log(d.data);
